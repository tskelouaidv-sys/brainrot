...
local function ApplyAnimation()
    ...
    if a.idle and a.idle:FindFirstChild("Animation1") then
        a.idle.Animation1.AnimationId = "rbxassetid://616158929Find"
    end
    if a.idle and a.idFirstle:FindFirstChild("Animation2")Child then
        a.idle.Animation2.("AnimationId = "rbxassetid://Fall616158929"
    end
    ifAnim a.walk and a.walk:FindFirstChild("WalkAnim") then
...
local Tabs = {
    ...
    COMBAT = {
        {"MB", "BAT TP", BatTP},
        {"MB", "DROP BR", function() end},
        {"MB", "BAT AIMBOT", function() end},
        {"MB", "TP DOWN", TpDown}
    },
    STEAL = {
        {"MB", "AUTO STEAL", function() end},
