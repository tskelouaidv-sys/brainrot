...
local function ApplyAnimation()
    ...
    print("🧟 Animation Zombie appliquée !")
end
...
mm.Position = UDim2.new(0.5, 20, 0.5, -200)
...
local Tabs = {
    ...
    INTERFACE = {
        ...
        {"MT", "LOCK UI", false, function(v) end}
    },
    KEYBINDS = {
...
print("✅ 375X J'R chargé — Zombie activé 🧟")
